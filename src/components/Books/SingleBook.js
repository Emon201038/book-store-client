...
const SingleBook = ({ book }) => {
  ...
  const { id, name, author, price, thumbnail, rating, featured } = book;
      ...
      <div className="flex-1 h-full pr-2 pt-2 flex flex-col">
        <div className="flex items-center justify-between">
          ...
          <div className="text-gray-500 space-x-2">
            ...
            <button className="lws-delete" onClick={handleDeleteClick}>
              <svg
                fill="none"
                viewBox="0 0 24 24"
                strokeWidth="1.5"
        ...
        <div className="space-y-2 mt-4 h-full">
          ...
          <div className="lws-stars">{renderStars()}</div>
      ...
      {isModalOpen && (
        ...
        >
          <div className="bg-white p-4 pb-5 rounded-lg w-[500px] h-[200px] text-center shadow-2xl shadow-[black]">
            ...
            <button
              onClick={() => setIsModalOpen(false)}
              className="m-1 after:mt-4 p-1 rounded-lg bg-[green] w-[80px] text-white"
            >
              Cancel
            </button>
          </div>
