...
const Head = () => {
  ...
  return (
    <nav className="py-4 2xl:px-6 max-sm:relative max-sm:h-[80px]">
      <div className="container relative flex items-center justify-between ">
        <p className="max-sm:hidden"></p>
        <div
          className={`lg:hidden md:hidden max-sm:absolute max-sm:left-[40px] max-sm:mt-10 ${
            isOpen &&
        ...
        <ul
          ...
          ${!isOpen ? "hidden" : ""} max-sm:h-[250px] max-sm:w-[200px]   `}
        >
          <Link to={"/"}>
            <li
        ...
        <form
          className="flex items-center max-sm:absolute max-sm:right-0 max-sm:mt-10"
